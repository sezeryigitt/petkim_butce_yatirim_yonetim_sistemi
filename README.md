...
Yatirimlar, Butce, OperasyonelMaliyetler, Tesisler
...
Kopyala
Düzenle
GET /icerik/proje-karlilik
GET /icerik/risk-analizi
GET /icerik/gelir-gider-tablosu1
...
🔧 Kurulum Adımları
1. Backend (Node.js)
bash
...
Frontend: Lazy loading, veri önbellekleme (Map() ile)

Backend: MySQL connection pooling, JSON veri cache
